...
public class MyRecyclerAdapter2 extends RecyclerView.Adapter<MyRecyclerAdapter2.MyRecyclerViewHolder>
{
    ...
    public MyRecyclerAdapter2(ArrayList<Content> contentlist, Context context)
    {
        this.contentlist=contentlist;
        this.context=context;
        remainingTasksActivity=(RemainingTasksActivity)context;
...

    {
        ...
        MyRecyclerViewHolder recyclerViewHolder =  new MyRecyclerViewHolder(view,remainingTasksActivity,contentlist);
    ...
    public static class MyRecyclerViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener,View.OnLongClickListener
    {
        ...
        public MyRecyclerViewHolder(View itemView,RemainingTasksActivity remainingTasksActivity,ArrayList<Content> list) {
            super(itemView);

            TextTitle = (TextView) itemView.findViewById(R.id.TextTitle);
            TextDate = (TextView) itemView.findViewById(R.id.TextDate);
            TextTime = (TextView) itemView.findViewById(R.id.TextTime);
           this.remainingTasksActivity=remainingTasksActivity;

            context=remainingTasksActivity;
            contentlist=list;
        ...
        public void onClick(View v) {
            if (RemainingTasksActivity.longClick == false) {
            ...
            else
            {
              ...
              //  String titlesend=data.getTitle().toString();
                remainingTasksActivity.prepareSelection(v,getAdapterPosition(),data.getTitle());
            }
        }

        @Override
        public boolean onLongClick(View v) {
            RemainingTasksActivity.count++;
            if(RemainingTasksActivity.count==1) {
               cardView.setBackgroundColor(Color.GRAY);
                int position = getAdapterPosition();
                Content data = contentlist.get(position);
                String title = data.getTitle();
                remainingTasksActivity.funcCall(title);
                return true;
            }
            else {
              remainingTasksActivity.showerror();
                return false;
            }
        }
    }
